...
<div class="conBox" >
    ...
    <div class="booklist" id="booklet2"  style=" width: 88%;height: 100%;position: absolute;left:12%;display: block">
        <div class="booklistCon">
            ...
            <table>
                ...
                <c:forEach items="${sessionScope.FsShowBookList}" var="FsShowBookList">
                    <tr>
                        <td>${FsShowBookList.bookId}</td>
                        <td>${FsShowBookList.bookName}</td>
                        <td>${FsShowBookList.bookCbs}</td>
                        <td>${FsShowBookList.bookData}</td>
                        <td>${FsShowBookList.bookSort}</td>
                        <td><a href="/book/to_book_edit?bookId=${FsShowBookList.bookId}">详细</a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
    ...
    <div class="addbook" id="Handbook2" style=" width: 88%;height: 100%;position: absolute;left:12%;display: none">
        <form class="addbookCon" action="/book/book_add" method="post">
            ...
            <label for="category" class="addbookleft">书籍类别:</label>
            <label for="releaseDate" class="addbookright">书籍发行时间:</label><br><br>
    ...
    <div class="editbook" id="datebook2" style=" width: 88%;height: 100%;position: absolute;left:12%;display: none">
        <div  class="editbookCon">
            ...
            <table>
                ...
                <c:forEach items="${sessionScope.books}" var="itemedit">
                    <tr>
                        <td>${itemedit.bookId}</td>
                        <td>${itemedit.bookName}</td>
                        <td>${itemedit.bookCbs}</td>
                        <td>${itemedit.bookData}</td>
                        <td>${itemedit.bookSort}</td>
                        <td><a href="/book/to_book_edit?bookId=${itemedit.bookId}">修改</a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
