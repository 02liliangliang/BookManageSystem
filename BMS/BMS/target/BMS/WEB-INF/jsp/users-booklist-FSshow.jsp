    ...
    <div class="booklist" id="booklet2"  style=" width: 88%;height: 100%;position: absolute;left:12%;display: block">
        ...
        <div class="booklistCon">
            ...
            <table>
                ...
                <c:forEach items="${sessionScope.readerFsShowBookList}" var="readerFsShowBookList">
                    <tr>
                        <td>${readerFsShowBookList.bookId}</td>
                        <td>${readerFsShowBookList.bookName}</td>
                        <td>${readerFsShowBookList.bookCbs}</td>
                        <td>${readerFsShowBookList.bookData}</td>
                        <td>${readerFsShowBookList.bookSort}</td>
                        <td><a>详细</a></td>
                    </tr>
                </c:forEach>
            </table>
